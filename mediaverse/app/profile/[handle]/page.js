...
import { StarIcon } from "../../components/media/Mediathemes";
...
export default function ProfilePage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-[#06080f] text-gray-50 overflow-x-hidden font-serif">
      ...
      {/* Background accents — same as landing page */}
      <div
  ...
  <Link href="/#media"    className="hover:text-gray-100 transition-colors">Media</Link>
  <Link href="/#features" className="hover:text-gray-100 transition-colors">Features</Link>
  <Link href="/#reviews"  className="hover:text-gray-100 transition-colors">Reviews</Link>
          ...
          <button
            ...
            className={`px-5 py-2 text-sm font-bold rounded-xl transition-colors ${
              following
                ...
                : "bg-emerald-300 text-[#06080f] hover:bg-emerald-200"
            }`}
          >
